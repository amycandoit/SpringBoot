...
//CHECK LOGIN USRE
    ...
    public Page<TodoResponse> getAll(PageRequest pageRequest, TodoCondition todoCondition) {
//        Page<Todo> allByCondition = todoRepository.findAllByCondition(pageRequest, todoCondition);
//        return allByCondition.map(TodoResponse::new);
        return todoRepository.findAllByCondition(pageRequest, todoCondition);
    }
}
